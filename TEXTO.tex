...
\setuppapersize     [16x23]       %[17x12plus]
...
[{width=0.8\textwidth},
%grid=top,
before={\page\stoppagecolumns\mbox{}\blank[6cm]},
after={\startpagecolumns[example]},
number=no,
style=bfd,
...
\subject{TUSP como modelo de teatro político}
...
primeiros ensaios. O TUSP publicou a revista {\em aParte} e realizou
...
Ainda que o TUSP não fosse um grupo de {\em teatro político} no sentido
...
século XX, porém, a ideia de um {\em teatro político} assume feições
...
\title{PARA A FORMAÇÃO DE UM COLETIVO ARTÍSTICO-CULTURAL}
...
CPCs, o da montagem da peça {\em A Mais-Valia vai acabar, Seu Edgar}, de
...
proposta.”\footnote{Conforme testemunho de Chico de Assis, “A
  ...
  (LITS), {\em Peças do CPC}, de Oduvaldo Vianna Filho (São Paulo:
...
chegou a ser praticada pelo TUSP, algo desse ideal {\em trans-estético}
...
que seu GUT tenha no passado encenado {\em Auto da Barca do Inferno} e a
...
de {\em Morte e Vida Severina}, do TUCA, por sua grandeza e “alto nível
...
{\em Indústria Cultural} foi a que mais confirmou a decisão do TUSP de
...
fala no Congresso do TUSP reproduzida pelo jornal {\em O Estado de S.
Paulo}.\footnote{“Congresso vai definir a orientação do TUSP”, {\em O
...
A segunda atividade do TUSP foi a promoção de uma série de {\em cursos
...
{\em Século XX: Civilização das Imagens}. Este curso foi depois
...
o TUSP, a partir dali, teria no {\em teatro épico} brechtiano uma
...
debates fílmicos. O TUSP organizou em 1967 um curso de {\em Cinema de
...
Por fim, o grupo organizou pelo menos um show de {\em Música
...
MAGEM 1 A 4 - DIVULGAÇÃO DE CURSOS DO
TUSP{\externalfigure[media/image47.jpg][width=2.95276in,height=3.69938in]}{\externalfigure[media/image51.jpg][width=2.95276in,height=3.69094in]}{\externalfigure[media/image53.jpg][width=2.95276in,height=3.68251in]}{\externalfigure[media/image49.jpg][width=2.95276in,height=3.72047in]}
...
IMAGEM 5 - Declaração Teatro Universitário
Arcozelo{\externalfigure[media/image17.png][width=5.79688in,height=6.94417in]}

{[}{\em O Globo}, Rio de Janeiro, 7 jul. 1967, p. 5{]}
...
primeiro espetáculo do TUSP. Teria que ter um enfoque {\em didático} e
...
%DOCUMENTO 1 - DECIDIR SE SERÁ TRANSCRITO OU IMAGEM (APARTE 1)
{\externalfigure[media/image30.png][width=5.02604in,height=7.62881in]}
{\externalfigure[media/image14.png][width=5.40104in,height=8.08294in]}

%DOCUMENTO 2 - DECIDIR SE SERÁ TRANSCRITO (APARTE 2)

{\externalfigure[media/image42.png][width=5.18229in,height=8.01147in]}

{\externalfigure[media/image26.png][width=5.19271in,height=3.18553in]}

\title{EXPERIMENTO DE TEATRO VOLANTE: {\em A EXCEÇÃO E A REGRA}}
...
politizado do que o do CPC, incluía obras de Suassuna como {\em A Pena e
...
O texto agora escolhido pelo TUSP foi uma das chamadas {\em peças de
...
A decisão do TUSP pela encenação de {\em A exceção e a regra} como
...
O COMERCIANTE: {\bf Nós} temos que atravessar.

O CARREGADOR: Muitas vezes espera-se oito dias, antes de atravessar com
segurança. Agora é perigoso.

O COMERCIANTE : Isso é o que nós vamos ver. {\bf Nós} não podemos perder
um dia.

O CARREGADOR : Então {\bf precisamos} achar um barco ou uma canoa.
...
IMAGENS 6 E 7 - PÁGINAS DO ROTEIRO

{\externalfigure[media/image48.png][width=6.26772in,height=3.91667in]}
...
Em {\em A exceção e a regra}, existe uma dialética temporal produzida
...
IMAGEM 8 - A EXCEÇÃO E A REGRA - SINDICATO

{\externalfigure[media/image52.jpg][width=5.22917in,height=4.20963in]}

Atores antes da apresentação no Sindicato dos Bancários. Sérgio Mindlin
...
IMAGEM 9 - A EXCEÇÃO E A REGRA - PROJEÇÃO (APARTE
2){\externalfigure[media/image10.png][width=5.90551in,height=4.53424in]}

Projeção e sombras em {\em A exceção e a regra}. Ator não identificado
como o Carregador e André Gouveia como o Guia. Autor desconhecido.
{\em aParte}.

\title{TEATRO DE GUERRILHA COMO IDEIA EM DISPUTA}

O conceito {\em teatro de guerrilha} - que pode ser associado de modo
...
foi imediata. O TUSP, por exemplo, publicou na revista {\em aParte} o
...
Em um texto de 1968, {\em Cultural Revolution USA}, Davis afirma que
...
confortadora.\footnote{Sartre comenta o Maio de 1968 francês na
  entrevista {\em Sartre par Sartre}, publicada em {\em Situations}, IX
...
deve querer e ser capaz de tomar o poder”.\footnote{Trata-se do
  mencionado ensaio {\em Cultural Revolution USA}, reproduzido em
...
\title{EXPERIMENTO DE MOBILIZAÇÃO TEATRAL: {\em OS FUZIS DE DONA TEREZA CARRAR}}
...
estavam mais próximos. O TUSP decidiu fazer um teatro {\em dos
...
A escolha do TUSP em encenar {\em Os fuzis da Senhora Carrar} deve ser
...
Assim como fizeram em {\em A exceção e a regra}, o TUSP convidou um
...
preparação de elenco no TUSP desde {\em A exceção e a regra}, para
...
{\em guerrilha}. O TUSP não estava especialmente interessado no
...
Ao longo dos ensaios de {\em Os fuzis} pelo TUSP essa teatralidade
...
{\externalfigure[media/image1.png][width=4.33333in,height=6.72917in]}

IMAGENS 10 a 21 - PROGRAMA DO ESPETÁCULO

(SUGESTÃO: CADA PÁGINA DO PROGRAMA COMO UMA PÁGINA DO LIVRO)

{\externalfigure[media/image28.jpg][width=6.26772in,height=0.69444in]}

IMAGEM 22 - PÁGINA DIFERENTE DO
PROGRAMA{\externalfigure[media/image24.jpg][width=6.26772in,height=4.95833in]}Um
...
IMAGEM 23 - CONVITE
FUZIS{\externalfigure[media/image9.png][width=6.26772in,height=3.44444in]}

Convite do espetáculo no Rio de Janeiro. Acervo Flávio Império.

\title{IMAGENS DE {\em OS FUZIS}: PESQUISA DOS GESTOS}

Quando o TUSP realizava os últimos ensaios de {\em Os fuzis}, no início
...
IMAGEM 24
CENÁRIO{\externalfigure[media/image23.jpg][width=6.26772in,height=4.69444in]}

Fotógrafo: L. Pinto. 1968. Acervo Última Hora. Arquivo Público do Estado
de São Paulo.
...
IMAGEM 25 SRA
CARRAR{\externalfigure[media/image11.jpg][width=3.89764in,height=5.90551in]}

Bety Chachamovitz como Senhora Carrar. 1968. Fotógrafo: Victor Knoll.
Acervo pessoal.

\startitemize[R][start=2,packed]
\item
  Rede trágica
\stopitemize
...
IMAGENS 26 A 37 {\em SLIDES}

{\externalfigure[media/image43.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image21.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image34.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image7.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image12.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image27.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image31.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image4.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image39.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image3.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image5.jpg][width=1.9685in,height=1.2909in]}{\externalfigure[media/image8.jpg][width=1.9685in,height=1.2909in]}

{\em Slides}. Acervo Flávio Império.

\startitemize[R][start=3,packed]
\item
  Sangue audiovisual
\stopitemize
...
IMAGEM 38 - CARRAR E O FILHO
{\externalfigure[media/image18.jpg][width=5.90551in,height=3.8622in]}

Bety Chachamovitz como Senhora Carrar. 1968. Fotógrafo: Victor Knoll.
Acervo pessoal

\startitemize[R][start=4,packed]
\item
  O mar dos pobres
\stopitemize
...
IMAGEM 39 -
PEDRO){\externalfigure[media/image44.jpg][width=6.26772in,height=4.69444in]}

André Gouveia como José, Sérgio Mindlin como o operário Pedro Jáqueras e
Bety Chachamovitz como Senhora Carrar. 1968. Autor desconhecido. Acervo
Diários Associados. Arquivo Público do Estado de São Paulo.

\startitemize[R][start=5,packed]
\item
  Irmão e combatente
\stopitemize
...
MÃE {\em cortando a conversa} - Não!
...
JOSÉ {\em rindo} - Eu já trapaceei alguma vez?
...
IMAGEM 40 - BRIGADAS
1{\externalfigure[media/image35.jpg][width=5.90551in,height=4.34646in]}André
Gouveia como José Carrar. 1968. Fotógrafo: Victor Knoll. Acervo pessoal

IMAGEM 41 - BRIGADAS
2{\externalfigure[media/image41.jpg][width=6.26772in,height=4.69444in]}

À esquerda, ator não identificado. À direita, Renata Souza Dantas como
Manuela. 1968. Fotógrafo: L. Pinto. Acervo Última Hora. Arquivo Público
do Estado de São Paulo.

IMAGEM 42 - BRIGADAS
3{\externalfigure[media/image45.jpg][width=5.90551in,height=3.94094in]}

Sérgio Mindlin como o operário Pedro Jáqueras, ator não identificado e
Bety Chachamovitz como Senhora Carrar. 1968. Fotógrafo: Victor Knoll.
Acervo Flávio Império.

\startitemize[R][start=6,packed]
\item
  Passagem épica
\stopitemize
...
IMAGEM 43 - MANUELA
1{\externalfigure[media/image25.jpg][width=4.68906in,height=3.5649in]}

Renata Souza Dantas como Manuela, André Gouveia como José, Sérgio
...
IMAGEM 44 - MANUELA
2{\externalfigure[media/image32.jpg][width=4.49664in,height=3.55224in]}

Renata Souza Dantas como Manuela, André Gouveia como José, Sérgio
Mindlin como o operário Pedro Jáqueras e (de costas) Bety Chachamovitz
como Senhora Carrar. 1968.
...
{\externalfigure[media/image15.jpg][width=5.90551in,height=3.9252in]}

\startblockquote
Renata Souza Dantas como Manuela. 1968. Fotógrafo: Victor Knoll. Acervo
pessoal.
\stopblockquote

IMAGEM 46 - MANUELA
4{\externalfigure[media/image36.jpg][width=4.92032in,height=3.16612in]}
...
IMAGEM 47 - PADRE
1{\externalfigure[media/image22.jpg][width=5.36719in,height=3.57813in]}

Moacyr Urbano Villela como o Padre, Sérgio Mindlin como o operário Pedro
Jáqueras e Bety Chachamovitz como Senhora Carrar. 1968. Fotógrafo:
Victor Knoll. Acervo Flávio Império.

IMAGEM 48 - PADRE
2{\externalfigure[media/image46.jpg][width=5.82292in,height=3.7148in]}

Sérgio Mindlin como o operário Pedro Jáqueras, Moacyr Urbano Villela
...
PADRE {\em (levando as mãos à altura da cabeça, num gesto defensivo)} -
Isso eu não admito!

OPERÁRIO ({\em fitando-o com os olhos semicerrados)} - Fique um instante
...
IMAGEM 49 - SRA
PEREZ{\externalfigure[media/image16.jpg][width=5.10938in,height=3.7918in]}

Sérgio Mindlin como o operário Pedro Jáqueras, Cida Previatti como
...
IMAGEM 50 - JOSÉ E TEREZA 1

{\externalfigure[media/image37.jpg][width=2.71232in,height=4.04977in]}

André Gouveia como José e Bety Chachamovitz como Senhora Carrar. 1968.
Fotógrafo: Victor Knoll. Acervo pessoal.

IMAGEM 51 - JOSÉ E TEREZA
2{\externalfigure[media/image38.png][width=3.96354in,height=2.97744in]}

Bety Chachamovitz como Senhora Carrar e André Gouveia como José. 1968.
Fotógrafo: Victor Knoll. Acervo Flávio Império.

\startitemize[R][start=9,packed]
\item
  Luta pelas armas
\stopitemize
...
IMAGEM 52 -
CORO{\externalfigure[media/image40.png][width=5.90551in,height=3.31496in]}

Atrizes não identificadas. 1969. {\em Frame} do documentário
{\em Festival Mondial du Théâtre de Nancy} (1999).

\startitemize[R][start=10,packed]
\item
...
IMAGEM 53 - MATER
DOLOROSA{\externalfigure[media/image6.png][width=4.9468in,height=2.77439in]}

Atores não identificados. 1969. {\em Frame} do documentário
{\em Festival Mondial du Théâtre de Nancy} (1999).

\startitemize[R][start=11,packed]
\item
  {\em Mater Dolorosa}
\stopitemize
...
IMAGEM 54 - TEREZA
PARTE{\externalfigure[media/image2.png][width=2.54063in,height=3.39063in]}

Bety Chachamovitz como Senhora Carrar. 1968. Fotógrafo: Victor Knoll.
Acervo Flávio Império.

\startitemize[R][start=12,packed]
\item
  Decisão das Terezas
\stopitemize
...
MÃE {\em com simplicidade} - A culpa foi do boné.
...
IMAGEM 55 - MISSA NEGRA

{\externalfigure[media/image13.jpg][width=3.125in,height=4.625in]}

Moacyr Urbano Villela como Bispo acompanhado de ator não identificado.
1968. Fotógrafo: Victor Knoll. Acervo pessoal.

\startitemize[R][start=13,packed]
\item
  Guerra capitalista
\stopitemize
...
monótona dos efeitos do {\em napalm}. O espetáculo do TUSP se encerra
...
\title{MOBILIZAÇÃO CULTURAL ALÉM DO ESPETÁCULO: A REVISTA {\em APARTE}}

IMAGEM 56 - CAMISETAS

{\externalfigure[media/image19.jpg][width=5.34133in,height=7.12474in]}

Renata Souza Dantas e André Gouveia com camisetas que anunciavam o
...
ensaio famoso de Vianinha {\em Do Arena ao CPC}, publicado na revista
{\em Movimento} da UNE, reflexão que antecedeu a criação de um setor de
...
Teatro Experimental do Negro a partir de 1948, das {\em Edições TEP}, do
...
IMAGEM 57 - APARTE 1 CAPA

{\externalfigure[media/image29.png][width=2.71654in,height=3.93701in]}{[}QR
code de acesso à digitalização?{]}

{\em aParte} número 1, como se vê na capa, tem como questão orientadora
...
{\em Primeira Feira Paulista de Opinião}.\footnote{O livro organizado
  pelo LITS, {\em Primeira Feira Paulista de Opinião} reúne pela
...
pelo TUSP, e a resenha de seu livro {\em Brasil em tempo de cinema},
...
IMAGEM 58 - APARTE 2 CAPA

{\externalfigure[media/image54.jpg][width=2.2829in,height=3.35773in]}{[}QR
code de acesso à digitalização?{]}
...
come.”\footnote{“MMPB: uma análise ideológica”. {\em aParte}, São Paulo,
...
IMAGEM 59 - APARTE DEOPS

{\externalfigure[media/image50.jpg][width=2.49535in,height=3.52604in]}

IMAGEM 60 - APARTE 3 CAPA

{\externalfigure[media/image20.jpg][width=2.79528in,height=3.93701in]}
...
\title{IMPROVISAÇÕES DO TEATRO ÉPICO NO BRASIL}

{\em Os fuzis de Dona Tereza Carrar} foi a maior realização da breve
...
incidentes de março de 1968.\footnote{“Informação” por Marina de Mello
  ...
  peça {\em Os fuzis da Senhora Carrar}, de Bertolt Brecht. BR DFANBSB
  NS.CPR.TEA, PTE.370.}
\stopblockquote
...
IMAGEM 61 PRIMEIRO
LUGAR{\externalfigure[media/image33.png][width=5.90551in,height=6.08268in]}
...
{\em Morte e vida Severina} montada pelo TUCA -- Teatro da Universidade
...
posto ele em cena no {\em Sítio do Picapau Amarelo} na TV Tupi) e ele e
...
fazendo a música. No TUSP, nós tínhamos essa concepção desde {\em A
...
\startblockquote
{\em A montagem truncada de “Mann ist Mann”}
\stopblockquote
...
\startblockquote
{\em Repressão política e fim do TUSP}
...
{\em Chapéu Mangueira, onde} atuava um grupo do PCB. Foi assim que
...
Em 1999 quando a {\em Via Campesina} e o {\em MST} me convidaram para ir
...
Nancy com o {\em Bread and Puppet{\bf . }}Pensei comigo mesmo: estou de
novo no lugar certo.
...
{\em A Exceção e a Regra} do TUSP. A Bety Cacha do TUSP e Dina Sfat
...
\subject{Caminhos do teatro estudantil no Brasil do século XX}
...
{\bf Pedra angular - Teatro do Estudante do Brasil}
...
{\em Romeu e Julieta}, no encerramento do II Congresso Nacional dos
...
{\bf Constituição de uma cena estudantil no teatro brasileiro dos anos
1940 e 1950}
...
sua trajetória artística com {\em A incubadeira.} O III Festival ocorreu
...
{\bf Estudantes e a ideia de nacional-popular - Teatro Paulista do
Estudante}
...
atribuída ao TPE e muito provavelmente escrita antes de {\em Eles não
...
{\bf Efervescência política e cultural dos anos 1960}
...
exemplo, a estreia do TUSP, em São Paulo, com {\em A exceção e a regra}
...
Quando o TUSP encenou {\em Os fuzis da Senhora Carrar}, a peça já era
...
Na EAD, Alfredo Mesquita dirigiu {\em A exceção e a regra} em 1951,
...
Entre 1951, quando a EAD encenou {\em A exceção e a regra}, e 1968, ano
da estreia de {\em Os fuzis} pelo TUSP, foi possível rastrear 49
...
{\em Schweik na II Guerra Mundial}
