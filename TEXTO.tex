...
Prado não era propriamente um entusiasta do {\it teatro popular}, ainda
...
que escreveu sobre o assunto,\footnote{“O Teatro documentário”,
  publicado em {\it Prismas do Teatro} (São Paulo: Perspectiva, 2008, p.
...
O tema do chamado {\it teatro do absurdo}, conforme a expressão difusa
...
{\it Seminário sobre Comunicação de Massa}, que funcionava como um lugar
...
debates fílmicos. O {\sc tusp} organizou em 1967 um curso de {\it Cinema de
...
\letterspacing[-.025]{Por fim, o grupo organizou pelo menos um show de {\it Música
...
realidade.\footnote{Seu manifesto {\it The Revolutionary Theatre} foi
  ...
  {\it Liberator} (vol. V, n. 7, july 1965).}
\stopblockquote
...
deve querer e ser capaz de tomar o poder”.\footnote{Trata-se do
  ...
  {\it The San Francisco Mime Troupe: the first ten years}. (Idem, p.
...
agitação revolucionária”.\footnote{Seu texto “Le festival des groupes
  ...
  {\it Travail Théâtral}, n. 17, oct.-déc. 1974, p. 124.}
...
Em 1962 o {\sc cpc} participou ativamente das {\sc une}-Volantes\footnote{Aldo
  ...
  peça {\it O Auto dos 99\letterpercent{}}, além de exibir o filme
