...
\startpositioning
   \position(-2.7,-4){\externalfigure[./media/DOC1.pdf][page=1,width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.5,-4){\externalfigure[./media/DOC1.pdf][page=2,width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.7,-4){\externalfigure[./media/DOC2.pdf][page=1,width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.5,-4){\externalfigure[./media/DOC2.pdf][page=2,width=1.1\paperwidth]}
\stoppositioning   
...
mais próxima do {\it teatro na rua}, em que o público poderia assistir à
...
foi o da-2.1{-3it mobilização}.

\page

\startpositioning
   \position(-2.5,-4){\externalfigure[./media/DOC3.pdf][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3.7,-2.6){\externalfigure[./media/IMAGEM10.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.5,-4){\externalfigure[./media/IMAGEM11.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3.3,-2.6){\externalfigure[./media/IMAGEM12.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3,-2.6){\externalfigure[./media/IMAGEM13.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.7,-4){\externalfigure[./media/IMAGEM14.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3,-2.6){\externalfigure[./media/IMAGEM15.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.7,-4){\externalfigure[./media/IMAGEM16.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3,-2.6){\externalfigure[./media/IMAGEM17.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3.3,-2.6){\externalfigure[./media/IMAGEM18.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3,-2.6){\externalfigure[./media/IMAGEM19.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-2.7,-4){\externalfigure[./media/IMAGEM20.png][width=1.1\paperwidth]}
\stoppositioning   

\stoppagecolumns
\startpositioning
   \position(-3,-4.4){\externalfigure[./media/IMAGEM21.png][width=1.1\paperwidth]}
\stoppositioning   
...
\placefigure[top]{Bety Chachamovitz como Senhora Carrar. 1968. Fotógrafo: Victor Knoll.
...
\letterspacing[-.02]{{\sc mãe}: Nós não somos revoltosos e não estamos fazendo frente a ninguém.
...
\noindent{}A chegada do irmão de Tereza da frente de batalha aumenta a pressão
...
\letterspacing[-.025]{No texto de Brecht, ela se senta sobre a caixa de armas. Quando José faz
...
\letterspacing[-.025]{Na peça de Brecht, a última frase em fúria de Carrar -- “quem com ferro
...
\letterspacing[-.025]{{\it Os fuzis da Senhora Carrar} é uma peça estruturalmente dramática,
...
\letterspacing[-.025]{Em tal contexto, a multiplicação de mães Carrar em meio à plateia
...
\title[list={Anexo: Brecht no Brasil até 1968},title={ANEXO}\\Brecht no Brasil até 1968]

\noindent{}Quando o {\sc tusp} encenou {\it Os fuzis da Senhora Carrar}, a peça já era
...
Santo André-{\sc sp}\blank[medium]
...
Belo Horizonte-{\sc mg}\blank[medium]
...
Rio de Janeiro-{\sc rj}\blank[medium]
...
Direção: Wagner Melo\\
Teatro de Arena\\
Porto Alegre-{\sc rs}\blank[medium]
